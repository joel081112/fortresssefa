...
function _(e,t){return-1===e?Math.floor(t):Math.ceil(t)}
function x(e,t,n){return Math.max(Math.min(n,t),e)}
function M(e,o,i){return o===t?0:o===n?L(e):o===r?_(i,L(e)/2):0}
function E(e,o,i){return o===t?0:o===n?C(e):o===r?_(i,C(e)/2):0}
function w(e){return e.scrollHeight}
function S(e){return e.scrollWidth}
function L(e){return e.offsetHeight}
function C(e){return e.offsetWidth}
function R(e){return e.offsetLeft+e.clientLeft}
function T(e){return e.offsetTop+e.clientTop}
function A(e,t){var n=Math.abs(e-t),r=100/Math.max(document.documentElement.clientHeight,window.innerHeight||1)*n,o=100/s*r;return isNaN(o)?0:Math.max(s/1.5,Math.min(o,s))}
