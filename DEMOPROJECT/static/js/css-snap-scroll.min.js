!function (e, t) {
    ...
    !function (e, t, n) {
        ...
        function a(e) {
            return this instanceof a ? (this._options = e, e.keywords || (this._options = {keywords: e}), this._promise = [], this._getStylesheets(), this._downloadStylesheets(), this._parseStylesheets(), this._filterCSSByKeywords(), this._buildMediaQueryMap(), this._reportInitialMatches(), void this._addMediaListeners()) : new a(e)
        }

        var l = RegExp("^" + String({}.valueOf).replace(/[.*+?\^${}()|\[\]\\]/g, "\\$&").replace(/valueOf|for [^\]]+/g, ".+?") + "$"),
            c = function () {
                var e = t.getElementsByTagName("base")[0], n = /^([a-zA-Z:]*\/\/)/;
                return function (t) {
                    return !n.test(t) && !e || t.replace(RegExp.$1, "").split("/")[0] === location.host
                }
            }(), u = {
                matchMedia: e.matchMedia && e.matchMedia("only all").matches, nativeMatchMedia: function (e) {
                    return l.test(e)
                }(e.matchMedia)
            }, f = function () {
                function t() {
                ...
                _cache: {}, clearCache: function () {
                    ...
                    function i() {
                        var t, n = [];
                        for (a(), l(n); "}" != e.charAt(0) && (t = function () {
                            if (t = s(/^@([\-\w]+)?keyframes */)) {
                                var e = t[1], t = s(/^([\-\w]+)\s*/);
                                if (t) {
                                    var r = t[1];
                            ...
                            if (e) {
                                ...
                                if (n()) {
                                    l();
                                    var a = i();
                                    if (o()) return {supports: t, rules: a}
                                }
                            }
                            ...
                            if (s(/^@page */)) {
                                ...
                                if (n()) {
                                    ...
                                    if (o()) return {type: "page", selectors: e, declarations: t}
                                }
                            }
                        }() || y());) n.push(t), l(n);
                        return n
                    ...
                    function c() {
                        if ("/" == e[0] && "*" == e[1]) {
                            for (var t = 2; "*" != e[t] || "/" != e[t + 1];) ++t;
                            t += 2;
                            var n = e.slice(2, t - 2);
                            return e = e.slice(t), a(), {comment: n}
                        }
                    }
                    ...
                    function f() {
                        ...
                        if (e && (e = e[0], s(/^:\s*/))) {
                            var t = s(/^((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^\)]*?\)|[^};])+)\s*/);
                            if (t) return t = r(t[0]), s(/^[;\s]*/), {property: e, value: t}
                        }
                    }

                    function h() {
                        for (var e, t = []; e = s(/^(from|to|\d+%|\.\d+%|\d+\.\d+%)\s*/);) t.push(e[1]), s(/^,\s*/);
                        return t.length ? {values: t, declarations: v()} : void 0
                    }

                    function p() {
                        var e = s(/^@([a-z\-]+) */);
                        if (e) return {type: e[1], declarations: v()}
                    }
                    ...
                    function y() {
                        var e = u();
                        if (e) return l(), {selectors: e, declarations: v()}
                    }
                    ...
                    function i(e, t) {
                        for (var n, o, i, s, a = /\*/, l = 0; n = t[l++];) if (o = n.split(":"), i = new RegExp("^" + r(o[0]).replace(a, ".*") + "$"), s = new RegExp("^" + r(o[1]).replace(a, ".*") + "$"), i.test(e.property) && s.test(e.value)) return !0
                    }
                    ...
                    function a(e, n, r) {
                        if (t.declarations) for (var s, a = 0; s = e.declarations[a++];) if (i(s, t.declarations)) return o({
                            media: n,
                            supports: r,
                            selectors: e.selectors,
                            declarations: e.declarations
                ...
                function n() {
                    if (o) return o;
                    var e = t.documentElement, n = t.body, r = e.style.fontSize, i = n.style.fontSize,
                ...
                var t = function () {
                    ...
                    return {
                        add: function (t, n, r) {
                            for (var o, i = 0; o = e[i++];) if (o.polyfill == t && o.mql === n && o.fn === r) return !1;
                            n.addListener(r), e.push({polyfill: t, mql: n, fn: r})
                        }, remove: function (t) {
                ...
                return {
                    removeListeners: function (e) {
                        ...
                        var i = e._mediaQueryMap, s = {};
                        !function () {
                            for (var e in i) i.hasOwnProperty(e) && (s[e] = h.matchMedia(e).matches)
                        }(), function () {
                            if (u.nativeMatchMedia) for (var s in i) i.hasOwnProperty(s) && function (n, o) {
                                t.add(e, n, function () {
        ...
        i.prototype.each = function (e, t) {
            ...
            var e, n, r, i, s, a, l, u = 0, f = [];
            if (this._options.include) {
                for (n = this._options.include; e = n[u++];) if (r = t.getElementById(e)) {
                    if ("STYLE" === r.nodeName) {
                        l = {text: r.textContent}, f.push(l);
                        continue
                    }
                    if (r.media && "print" == r.media) continue;
                    if (!c(r.href)) continue;
                    l = {href: r.href}, r.media && (l.media = r.media), f.push(l)
                }
            } else {
                for (n = this._options.exclude, i = t.getElementsByTagName("link"); r = i[u++];) r.rel && "stylesheet" == r.rel && "print" != r.media && c(r.href) && !o(r.id, n) && (l = {href: r.href}, r.media && (l.media = r.media), f.push(l));
                for (a = t.getElementsByTagName("style"), u = 0; s = a[u++];) l = {text: s.textContent}, f.push(l)
            }
            ...
            MediaManager: h,
            EventManager: p
        }, a.constructors = {Ruleset: i, Rule: s}, e.Polyfill = a
    }(window, document);
    const e = "none", t = "start", n = "end", r = "center", o = /(\d+)(px|vh|vw|%)/g, i = .18, s = 350;

    function a(t) {
        t.each(t => {
            const n = document.querySelectorAll(t.getSelectors()), r = t.getDeclaration();
            [].forEach.call(n, t => {
                !function (t, n) {
                    if (void 0 !== n["scroll-snap-align"]) return t.scrollSnapAlignment = function (t) {
                        const {"scroll-snap-align": n} = t;
                        let r = e, o = e;
                        if (void 0 !== n) {
                            const e = n.split(" ");
                    ...
                    t.addEventListener("scroll", p, !1), t.scrollPadding = function (e) {
                        const {"scroll-padding": t, "scroll-padding-top": n, "scroll-padding-right": r, "scroll-padding-bottom": o, "scroll-padding-left": i} = e;
                        let s = {value: 0, unit: "px"}, a = {value: 0, unit: "px"}, l = {value: 0, unit: "px"},
                            u = {value: 0, unit: "px"};
                        if (void 0 !== t) {
                            const e = t.split(" ");
                            e.forEach((e, t) => {
                        ...
                        void 0 !== o && (l = c(o));
                        void 0 !== i && (u = c(i));
                        return {top: s, right: a, bottom: l, left: u}
                    }(n), t.snapElements = []
                }(t, r)
            })
        })
    ...
    function c(e) {
        const t = o.exec(e);
        if (null === t) return {value: 0, unit: "px"};
        const [n, r, i] = t;
        return {value: parseInt(r, 10), unit: i}
    }

    let u, f, d = null, h = null, p = function (e) {
        ...
        let e, t = {y: h.y - f.scrollTop > 0 ? -1 : 1, x: h.x - f.scrollLeft > 0 ? -1 : 1};
        void 0 !== f.snapElements && f.snapElements.length > 0 && (e = function (e, t, n) {
            var r = t.snapElements.length, o = e.scrollTop, s = e.scrollLeft, a = Math.min(n.y, n.x), l = {y: 0, x: 0};
            const {top: c, right: u, bottom: f, left: d} = e.scrollPadding, h = _(n, g(c.value, c.unit, e)),
                p = (_(n, g(u.value, u.unit, e)), _(n, g(f.value, f.unit, e)), _(n, g(d.value, d.unit, e)));
            ...
            if (s > 0 && s + C(e) === S(e) || o > 0 && o + L(e) === w(e)) {
                y = r - 1;
                const o = t.snapElements[y], i = {
                    x: R(o) - R(e) + E(o, o.scrollSnapAlignment.x, n),
                    y: T(o) - T(e) + M(o, o.scrollSnapAlignment.y, n)
                };
                return o.snapCoords = i, {y: x(0, w(e), i.y), x: x(0, S(e), i.x)}
            }
            const A = t.snapElements[y], b = {
            ...
            A.snapCoords = b;
            const N = b.x + n.x * C(A) * i, z = b.y + n.y * L(A) * i;
            for (var k = y + a; k < r && k >= 0 && (v = t.snapElements[k], l = {
                ...
                const t = l.x + n.x * C(v) * i, r = l.y + n.y * L(v) * i;
                if (!(1 === n.x ? s > t : s < t) && !(1 === n.y ? o > r : o < r)) return y = k, {
                    y: x(0, w(e), m(l.y, h)),
                    x: x(0, S(e), m(l.x, p))
                }
            }
            if (1 == a && k === r - 1) return y = r - 1, {y: x(0, w(e), l.y), x: x(0, S(e), l.x)};
            if (-1 == a && 0 === k) return y = 0, {y: x(0, w(e), l.y), x: x(0, S(e), l.x)};
            return {
    ...
    function A(e, t) {
        var n = Math.abs(e - t), r = 100 / Math.max(document.documentElement.clientHeight, window.innerHeight || 1) * n,
            o = 100 / s * r;
    ...
    return () => {
        "scrollSnapAlign" in document.documentElement.style || "webkitScrollSnapAlign" in document.documentElement.style || "msScrollSnapAlign" in document.documentElement.style || Polyfill({declarations: ["scroll-snap-type:*", "scroll-snap-align:*", "scroll-snap-padding:*"]}).doMatched(a).undoUnmatched(l)
    }
});